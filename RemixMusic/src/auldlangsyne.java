...
public class auldlangsyne {

	private String[] lyrics;
	private String fileName = "auldlangsyne";	// this should match your txt file
	
//	private String[] wordsToReplace;	// for part 2, if you finish the main project
//	private String[] newWords;
	
	private String[] replace = {"auld", "lang", "syne", "tak"};
	private String[] replaceW = {"times", "long", "past", "take"};
	
	private String firstW= "auld";
	
	/*public void remix() {
		
		for (int i = 0; i < lyrics.length; i++) {
			if (lyrics[i].equals(firstW)) {
				lyrics[i] = "times";
			}
			if (lyrics[i].equals("lang")) {
				lyrics[i] = "long";
			}
			if (lyrics[i].equals("syne")) {
				lyrics[i] = "past";
			}
